...
flags.DEFINE_string("traindir", "./train/2014", "Directory to save checkpoints and gnuplot files.")
...
resultFile = open("2014/ResultFile_withattribute" + time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime()) + ".logging.csv", 'w')
...
dataset = "BPIC2014_withattribute.txt"
...
with tf.Graph().as_default() as G:
    ...
    if (targetVocabulary==inputVocabulary):
        outputFile = open(
            "2014/SuffixPrediction{0}Dataset.txt".format(dataset), "w")
